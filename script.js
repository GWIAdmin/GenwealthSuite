...
const STRATEGY_EFFECTS = {
  ...
  'Cost Segregation':                                     { kind: 'business_expense' },
  ...
  'Alternative Risk Insurance':                           { kind: 'business_expense' },
  ...
  'IRC Section 168 (Film)':                               { kind: 'business_expense' },
  'IRC Section 263 (Oil and Gas)':                        { kind: 'business_expense' },
  'Profit-Sharing Retirement Plan':                       { kind: 'business_expense' },
  'Qualified Employee Achievement Award Program (QEAAP)': { kind: 'business_expense' },
  'Rent to Real Estate':                                  { kind: 'business_expense' },
  'Restricted Property Trust':                            { kind: 'business_expense' },
  'Revenue Stream Bifurcation':                           { kind: 'business_expense' },
  'Short-Term Rentals & Real Estate Professional':        { kind: 'business_expense' },
  'Traditional 401(k) Plan - Client 1':                   { kind: 'business_expense' },
  'Traditional 401(k) Plan - Client 2':                   { kind: 'business_expense' },
  'Self-Directed 401(k) Plan - Client 1':                 { kind: 'business_expense' },
  'Self-Directed 401(k) Plan - Client 2':                 { kind: 'business_expense' },
  'Roth Contributions vs Traditional Contributions':      { kind: 'business_expense' },
  'Individual Retirement Account (IRA)':                  { kind: 'business_expense' },
  ...
  'IRC Section 170 (LAD)':                                { kind: 'itemized', field: 'contributions' },
  ...
  'Research & Development Credit':                        { kind: 'credit', field: 'generalBusinessCredit' },
  ...
  'Investment Tax Credits (ITC)':                                         { kind: 'credit', field: 'otherCredits' },
...
(() => {
 ...
 const STRATEGIES = [
  ...
  'Cash Balance Plan',
  'Cost Segregation',
  'Non-Operating Private Charitable Foundation',
  ...
  'Home Office',
  'IRC Section 168(k) Bonus Depreciation (CCM)',
  'Indexed Universal Life (IUL)',
  'Installment Sales',
  'IRC Section 168 (Film)',
  'IRC Section 7702 Retirement Strategy',
  'IRC Section 170 Strategy (LAD)',
